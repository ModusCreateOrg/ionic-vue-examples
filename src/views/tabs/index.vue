    ...
    <template slot="bottom">
      <ion-tab-bar>
        ...
        <ion-tab-button tab="foo">
          <ion-label>Foobar</ion-label>
          <ion-icon name="fire"></ion-icon>
        </ion-tab-button>
      </ion-tab-bar>
    </template>
  </ion-tabs>
...
export default {
  ...
  components: {
    // Home,
    // Settings,
    // Home: () => import([> webpackChunkName: "home" <] '@/views/tabs/Home.vue'),
    Settings: () => import(/* webpackChunkName: "settings" */ '@/views/tabs/Settings.vue'),
    foo: {
      template: '<h1>foo!</h1>',
      destroyed() {
